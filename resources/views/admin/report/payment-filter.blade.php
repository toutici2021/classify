...
@section('content')
    ...
    <div class="card card-dark">
        <div class="card-header">
            ...
            <a href="{{route('paymentExport',$selectedYear)}}" class="btn btn-danger float-right"><i
                    class="fas fa-download"></i>
                    Download Payment Report</a>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group mt-4">
                            <button type="submit"
                                    class="btn btn-danger float-right"><i class="fa fa-magic"></i> Filter Result
                            </button>
                        </div>
                    </div>
...
@section('script')
    <script src="{{asset('assets/dist/js/partial/payment-filter.js')}}"></script>
@stop
