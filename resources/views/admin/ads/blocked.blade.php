...
@section('content')
    ...
    <div class="loader loader-border" data-text="Unblocking ads, please wait."></div>
    <div class="row">
        <div class="col-md-12">
            <div class="card card-dark">
                <div class="card-header">
                    ...
                    <a href="{{route('create_ads')}}" class="btn btn-danger float-right"><i
                            class="fab fa-buffer"></i> Créer un nouvelle annoce 
                    </a>
                </div>
                <div class="card-body">
                    <table class="data-table table table-bordered table-hover">
                        ...
                        @foreach($ads as $ad)
                            <tr>
                                ...
                                <td> {{$ad->country ? $ad->country->country_name : ''}}</td>
