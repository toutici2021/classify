    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-dark">
                ...
                <div class="card-body">
                    <form action="{{route('storePage')}}" id="submit_test_email" method="post"
                          enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <label>Title</label>
                            <input id="test-email-to" type="text" name="title" value="{{old('title')}}"
                                   class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="post_content"
                                      placeholder="{{__('default.page_content')}}" id=""
                            ...
                            <div class="col-md-6">
                                <label for="show_in_header_menu" class="checkbox-inline">
                                    <input type="checkbox" value="1" id="show_in_header_menu"
                                           name="show_in_header_menu" {{old('show_in_header_menu') == 1 ? 'checked' : '' }} >
                            ...
                            <div class="col-md-6">
                                <label for="show_in_footer_menu" class="checkbox-inline">
                                    <input type="checkbox" value="1" id="show_in_footer_menu"
                                           name="show_in_footer_menu" {{old('show_in_footer_menu') == 1 ? 'checked' : '' }} >
                        ...
                        <a href="{{route('pages')}}" class="btn btn-danger">{{__('default.cancel')}} </a>
