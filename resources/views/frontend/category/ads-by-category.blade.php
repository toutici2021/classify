...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="container custom-container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('categories')}}">@lang('default.categories')</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-xl-3">
                        ...
                        @if(get_option('enable_monetize') == 1 && get_option('category_page_below_list_section'))
                            <div class="ads my-4">
                                {!! get_option('category_page_below_list_section') !!}
                            </div>
                        @endif
                    </div>
                            ...
                            @foreach($ads as $ad)
                                <div class="col-md-6 col-xl-3 mb-3">
                                    <div class="product-item">
                                        <div class="move-dir-box">
                                            ...
                                            <div class="product-img-box">
                                                ...
                                                <div class="position-absolute w-100 bottom category-price-holder">
                                                        <span
                                                            class="price  d-block text-center text-white text-14"> {{ get_option('currency_sign') }} {{$ad->price}} </span>
                                        ...
                                        <!--====== Title ======-->
                                            <a href="{{route('rootPath', [$ad->slug])}}"
                                               class="product-title text-brand-secondary"> {{\Illuminate\Support\Str::words($ad->title, 8)}} </a>
                                        </div>
