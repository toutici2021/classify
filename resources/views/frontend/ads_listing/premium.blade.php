            ...
            <div class="container custom-container">
                <div class="row">
                    <div class="col-lg-4 col-xl-3">
                        ...
                        @if(get_option('enable_monetize') == 1 && get_option('premium_ads_page_bottom_of_left_side_bar'))
                            <div class="ads my-4">
                                {!! get_option('premium_ads_page_bottom_of_left_side_bar') !!}
                            </div>
                        @endif
                                ...
                                <div class="col-md-6 col-xl-3 mb-3">
                                    <div class="product-item">
                                        <div class="move-dir-box">
                                            ...
                                            <span
                                                class="badge badge-warning ml-1">{{ucwords($ad->mark_ad_urgent ? 'Urgent':'')}}</span>
