...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="container custom-container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{request('key')}}</li>
        </ol>
    </nav>
            ...
            <div class="container custom-container">
                <div class="row">
                    <div class="col-lg-4 col-xl-3">
                        ...
                        @if(get_option('enable_monetize') == 1 && get_option('search_ads_page_bottom_of_left_side_bar'))
                            <div class="ads my-4">
                                {!! get_option('search_ads_page_bottom_of_left_side_bar') !!}
                            </div>
                        @endif
                                    ...
                                    <div class="product-item">
                                        <div class="move-dir-box">
                                            ...
                                            <div class="product-img-box">
                                                <img src="{{$ad->image ? asset(ad_thumb($ad->image->media_name)) : ''}}"
                                                     class="product-img" alt="Product Image">
                                            </div>
                                            <div class="dh-overlay">
                                                <div class="dir-move-content">
                                                    <div class="position-absolute w-100 center category-price-holder">
                                                        <span
                                            ...
                                            <!--========== Overlay Link ==========-->
                                            <a href="{{route('rootPath', [$ad->slug])}}" class="overlay-link"></a>
                                        </div>
