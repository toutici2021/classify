                    ...
                    <div class="panel-body user-panel-body">
                        <div class="body-content nicescroll">
                            ...
                            <div class="user-theme-block">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="embed-responsive-1by1">
                                                            @if($ad->image)
                                                                @if($ad->status == '1')
                                                                    <a href="{{route('rootPath', [$ad->slug])}}" target="_blank" class="embed-responsive-item">
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($ad->status == '1')
                                                            <a href="{{route('rootPath', [$ad->slug])}}" target="_blank" class="product-title mb-2" > {{$ad->title}} </a>
                                                        @else
                                                            {{$ad->title}}
                                                        @endif
                                                        ...
                                                        <ul class="list-inline mb-0">
                                                            <li class="list-inline-item">
                                                                <small class="text-muted"><i class="fa fa-eye"></i> Visiteurs : <strong>{{$ad->max_impression}}</strong> </small>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <span class="text-muted">|</span>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <time class="text-13 text-muted"><i class="fa fa-clock-o"></i> Publiés: {{$ad->postingDateTime()}}  </time>
                                                            </li>
                                                        </ul>
                                                    </td>
                                ...
                                @else
                                    <div class="min-vh-75">
                                        <h3 class="text-center pt-5">Annonces non trouvées</h3>
                                    </div>
                                @endif
                            </div>
